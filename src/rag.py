...
from .schemas import Citation, ChunkMetadata, RagAnswer, RetrievedChunk
from .store import get_client, get_vector_store
...
# ==========================================
# Render Prompt với Jinja2 (Trang 18)
# ==========================================
...
# ==========================================
# Pipeline Hỏi Đáp và Trích dẫn (Trang 18 - 19)
# ==========================================
